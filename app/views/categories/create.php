...
<div class="max-w-2xl mx-auto px-4 py-10">
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-8">
        <h1 class="text-2xl font-extrabold text-gray-800 mb-6">ایجاد دسته‌بندی جدید</h1>

        <form action="<?= $CFG->wwwroot; ?>/category/new" method="post" class="space-y-6">
            <div>
            ...
            <div class="flex items-center gap-3">
                <button type="submit" 
                        class="px-6 py-2 rounded-2xl bg-gradient-to-r from-green-400 to-teal-500 text-white font-bold hover:opacity-90 transition">
                    ایجاد
                </button>
